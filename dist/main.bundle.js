...
var UserService = /** @class */ (function () {
    function UserService() {
        this.users = [
            new __WEBPACK_IMPORTED_MODULE_1__models_user_model_client__["a" /* User */]('123', 'alice', 'qq', 'alice', 'alice', 'a@a.com'),
            new __WEBPACK_IMPORTED_MODULE_1__models_user_model_client__["a" /* User */]('234', 'bob', 'qq', 'bob', 'bob', 'b@b.com'),
            new __WEBPACK_IMPORTED_MODULE_1__models_user_model_client__["a" /* User */]('345', 'charlie', 'qq', 'charlie', 'charlie', 'c@c.com')
        ];
    }
    UserService.prototype.createUser = function (user) {
        this.users.push(new __WEBPACK_IMPORTED_MODULE_1__models_user_model_client__["a" /* User */](user._id, user.username, user.password, user.firstName, user.lastName, user.email));
    };
